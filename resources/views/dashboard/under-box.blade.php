...
<div class="bg-[#F2F2F7] rounded-2xl p-6 shadow-sm mb-6 mt-6 font-bold font-display">
...
<div class="bg-[#F2F2F7] rounded-2xl p-6 shadow-sm mb-6 font-bold font-display">
    <div class="flex items-center justify-between mb-3">
        <h3 class="text-base font-semibold text-gray-700">Overall Progress</h3>
    </div>
    <div class="w-full bg-white rounded-full h-3">
